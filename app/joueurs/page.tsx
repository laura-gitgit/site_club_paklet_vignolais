...
async function addJoueur(formData: FormData) {
  ...
  if (error) {
    ...
    redirect("/joueurs?error=insert");
  }

  revalidatePath("/joueurs");
  redirect("/joueurs?success=added");
}
...
async function toggleJoueur(formData: FormData) {
  ...
  revalidatePath("/joueurs");
  redirect("/joueurs?success=updated");
}
...
async function deleteJoueur(formData: FormData) {
  ...
  if (error) {
    redirect("/joueurs?error=delete");
  }

  revalidatePath("/joueurs");
  redirect("/joueurs?success=deleted");
}

export default async function JoueursPage({ searchParams }: PageProps) {
