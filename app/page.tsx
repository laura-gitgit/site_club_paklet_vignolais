...
export default async function Home() {
  const evenements = await getEvenements(1);
    ...
    <div className="grid gap-10">
      <section className="card grid gap-6">
        ...
        <h1 className="text-4xl font-semibold text-slate-900 md:text-5xl">
          Paklet Vignolais - Club de palet laiton à Vigneux-de-Bretagne
        </h1>
        <div className="grid max-w-3xl gap-4 text-lg leading-8 text-slate-600">
          <p>
            Le Paklet Vignolais est un club de palet laiton ancré à Vigneux-de-Bretagne,
            où le plaisir du jeu et la convivialité priment avant tout. Nous rassemblons
            aujourd'hui 34 licenciés, animés par la même passion et l'envie de partager
            de bons moments autour du palet.
          </p>
          <p>
            Ouvert à toutes et tous, notre club accueille aussi bien les joueurs débutants
            que les plus expérimentés. Chacun y trouve sa place, quel que soit son niveau.
            L'entraide, le respect et la progression collective sont au cœur de notre
            fonctionnement.
          </p>
          <p>
            Les entraînements se déroulent dans une ambiance chaleureuse, propice à
            l'apprentissage comme à la compétition, toujours dans un esprit de fair-play
            et de bonne humeur.
          </p>
      ...
      <section className="card">
        <div>
          <h2 className="text-2xl font-semibold text-blue-900">Évènements</h2>
          <p className="mt-2 text-slate-600">
            Les actualités et rendez-vous du club.
          </p>
        </div>

        {evenements.length === 0 ? (
          <p className="mt-4 text-slate-600">Aucun évènement pour le moment.</p>
        ) : (
